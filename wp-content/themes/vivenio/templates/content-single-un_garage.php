  ...
  <article class="property property--apartment" data-lat="<?= $address['lat'] ?>" data-lng="<?= $address['lng'] ?>">
    <div class="property__wrapper">
      ...
      <aside class="property__info">
        <p class="property__info__price"><?php esc_html_e('desde', 'vivenio'); ?> <?php the_field('property_price_min') ?><?php esc_html_e('€/mes', 'vivenio'); ?></p>
        ...
        <a href="<?= get_post_type_archive_link('un_garage') ?>" class="button"><?php esc_html_e('Volver al listado', 'vivenio'); ?></a>
      </aside>

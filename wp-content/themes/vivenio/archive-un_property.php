...
<section class="properties">
  ...
  <div class="prop-list">
    <div class="prop-list__wrapper">
      <h1 class="prop-list__title"><?php esc_html_e('Encuentra tu nueva casa de alquiler', 'vivenio'); ?></h1>
      <div class="prop-list__text">
        <p><?php _e('Creemos que una casa es mucho más que un lugar en el que vivir. <br>
                En Vivenio nuestro compromiso es ayudarte en todo lo que necesites para que crees tu hogar con nosotros. Abajo encontrarás un listado de nuestras viviendas y a la izquierda puedes utilizar los filtros de búsqueda para encontrar la casa que mejor se adapte a ti.', 'vivenio'); ?></p>
      </div>
